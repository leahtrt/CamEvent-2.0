        ...
        GoogleMap.OnMarkerClickListener
{
    ...
    public void onMapReady(GoogleMap map) {
        ...
        for(int i=0;i<eventinfos.size();i++) {
            ...
            Marker marker=mMap.addMarker(new MarkerOptions().position(new LatLng(Double.parseDouble(eventinfos.get(i).getEventLatitude()),Double.parseDouble(eventinfos.get(i).getEventLongitude()))).title(eventinfos.get(i).getEventTitle()));
            marker.setTag(0);}
        }
